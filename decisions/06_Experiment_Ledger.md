...
## EXP-CONFIRMATORY-PHASE-001 — Real-graph-centered confirmatory benchmark and CART gatekeeper workflow

- **Status:** Planned / governance only.
- **Date registered:** 2026-05-16.
- **Linked milestone:** GitHub milestone #10, `CONFIRMATORY-PHASE-001`.
- **Linked issues:** #126, #127, #128, #129, #130, #131, #132, #133 and #134.
- **Question answered:** Not yet empirical. This entry records the planned confirmatory workflow that will decide which real-graph-centered benchmark, diagnostics, CART gatekeeper and implementation-maturity claims become admissible.
- **Input instances:** N/A at M0. M1 will curate real graph candidates. M2 will define confirmatory synthetic controls.
- **Algorithms compared:** N/A at M0. M3 will smoke the active portfolio before M4 execution.
- **Budget protocol:** N/A at M0. M4/M5 must use a preregistered budget policy compatible with fixed-target, TTT, ECDF and attainment diagnostics.
- **Outputs generated:** Planned only. No empirical outputs are generated by M0.
- **Main finding:** N/A — planned entry only.
- **Limitations / caveats:** This entry does not support a performance claim, solver superiority claim, positive CART claim or monograph result claim. It only records the confirmatory workflow. Final prose remains blocked by #49 until the text surface is audited.
- **Can this support prose in the monograph?** No empirical prose. At most, after mapping, it can support methodology/governance wording that the confirmatory phase was preregistered before execution.
- **Mapped in `08_Results_to_Text_Map.md`:** No. No result exists yet.
